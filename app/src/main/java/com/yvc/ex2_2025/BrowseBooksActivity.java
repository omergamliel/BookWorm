...
public class BrowseBooksActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        books = new ArrayList<>();
        books.add(new Book("book", "noa kirel", R.drawable.book1));
        books.add(new Book("book2", "noa kirel", R.drawable.book1));
        books.add(new Book("book3", "noa kirel", R.drawable.book1));
