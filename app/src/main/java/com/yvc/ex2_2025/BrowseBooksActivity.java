...
public class BrowseBooksActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        books = new ArrayList<>();
        books.add(new Book("book", "noa kirel", R.drawable.twilight,"https://www.google.com/"));
        books.add(new Book("book2", "noa kirel", R.drawable.harrypotter,"https://www.google.com/"));
        books.add(new Book("book3", "noa kirel", R.drawable.nerddiaries,"https://www.google.com/"));
